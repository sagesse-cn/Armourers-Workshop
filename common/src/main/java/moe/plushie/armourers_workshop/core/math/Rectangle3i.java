...
public class Rectangle3i implements IRectangle3i {
    ...
    public Rectangle3i(IRectangle3f rect) {
        this(OpenMath.floori(rect.getX()), OpenMath.floori(rect.getY()), OpenMath.floori(rect.getZ()), OpenMath.floori(rect.getWidth()), OpenMath.floori(rect.getHeight()), OpenMath.floori(rect.getDepth()));
    }
