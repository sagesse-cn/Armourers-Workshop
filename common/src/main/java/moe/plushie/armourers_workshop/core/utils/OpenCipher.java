...
public class OpenCipher {
    ...
    private static final OpenCipher INSTANCE = new OpenCipher();
    ...
    public String encrypt(String... values) {
        ...
        var encodedBytes = convertTo(valueBytes, alphabetIn.length, alphabetOut.length);
    ...
    public String[] decrypt(String value) {
        ...
        var decodedBytes = convertTo(valueBytes, alphabetOut.length, alphabetIn.length);
