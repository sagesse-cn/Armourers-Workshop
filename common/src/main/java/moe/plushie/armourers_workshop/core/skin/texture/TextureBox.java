...
import moe.plushie.armourers_workshop.api.skin.texture.ITextureBox;
...
public class TextureBox implements ITextureBox {
    ...
    private EnumMap<OpenDirection, ITextureOptions> variantOptions;
    private EnumMap<OpenDirection, ITextureProvider> variantTextures;
    ...
    public void putTextureOptions(OpenDirection dir, ITextureOptions options) {
    ...
    public void putTextureProvider(OpenDirection dir, ITextureProvider textureProvider) {
    ...
    private ITextureOptions getTextureOptions(OpenDirection dir) {
        if (variantOptions != null) {
    ...
    private ITextureProvider getTextureProvider(OpenDirection dir) {
        if (variantTextures != null) {
