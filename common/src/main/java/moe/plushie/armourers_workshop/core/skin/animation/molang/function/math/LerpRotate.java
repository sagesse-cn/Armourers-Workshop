 ...
 */
public final class LerpRotate extends Function {

    private final Expression min;
    private final Expression max;
    private final Expression delta;

    public LerpRotate(Expression name, List<Expression> arguments) {
    ...
    public double compute(final ExecutionContext context) {
        return MathHelper.lerpYaw(delta.compute(context), min.compute(context), max.compute(context));
    }
}
