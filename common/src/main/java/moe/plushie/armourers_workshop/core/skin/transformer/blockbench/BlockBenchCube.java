...
public class BlockBenchCube extends BlockBenchElement {
    ...
    private final Map<Direction, BlockBenchCubeFace> faces;

    public BlockBenchCube(String uuid, String name, String type, boolean allowExport, boolean allowMirrorModeling, boolean boxUV, boolean mirrorUV, Vector2f uvOffset, Vector3f from, Vector3f to, Vector3f origin, Vector3f rotation, float inflate, Map<Direction, BlockBenchCubeFace> faces) {
    ...
    public Map<Direction, BlockBenchCubeFace> getFaces() {
        return faces;
    }
    ...
    public static class Builder extends BlockBenchElement.Builder {
        ...
        protected final Map<Direction, BlockBenchCubeFace> faces = new HashMap<>();
        ...
        public void addFace(Direction dir, BlockBenchCubeFace face) {
